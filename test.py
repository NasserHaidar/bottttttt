...
"""with open("assets\\PhotoXzZachem1024x1024.png", "rb") as image_file:
...
image = AI_requests.generate_image(prompt = "cosmos and starts on background, human on Spacesuit ", image_id = "c54422db-dbc1-4582-8778-7dc6dd23ce15")
"""if image:
    with open("retrieved_image.jpg", "wb") as image_file:
        image_file.write(image)
    print("Image retrieved and saved successfully.")
